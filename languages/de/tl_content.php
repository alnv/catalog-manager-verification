...
$GLOBALS['TL_LANG']['tl_content']['catalog_verification_legend'] = 'Verifizierungs-Einstellungen';

$GLOBALS['TL_LANG']['tl_content']['catalogAfterVerificationMessage'] = [ 'Verifizierungs-Anzeigentext', 'Dieser Anzeigentext wird standardmässig angezeigt, wenn ein Datensatz erfolgreich verifiziert worden ist.' ];
...
$GLOBALS['TL_LANG']['tl_content']['reference']['catalogAfterVerificationHandlerType'] = [

    'message' => 'Nachricht anzeigen',
    'staticRedirect' => 'Weiterleiten',
    'detailRedirect' => 'Weiterleiten zur Detailansichtsseite'
];